...
const content = {
  ...
  fa: {
    eyebrow: "۰۴",
    title: "تماس",
    subtitle: "پروژه‌ای تو ذهنت هست یا فقط می‌خوای سلام کنی؟ برام پیام بفرست.",
    name: "نام",
    email: "ایمیل",
    message: "پیام",
    submit: "ارسال پیام",
      ...
      <Container className="max-w-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          <div>
            ...
            />
            {errors.name && (
              <p className="text-sm text-red-400 mt-1.5">{errors.name.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.message && (
              <p className="text-sm text-red-400 mt-1.5">{errors.message.message}</p>
            )}
          </div>
