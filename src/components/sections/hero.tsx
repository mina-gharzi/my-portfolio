...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[75vh] md:min-h-[65vh] flex items-center py-24"
    >
      <Container>
        <FadeIn>
      ...
      <a
        ...
        className={cn(
          "flex flex-col items-center gap-2 absolute bottom-6 md:bottom-10 inset-s-1/2 -translate-x-1/2 rtl:translate-x-1/2 text-text-muted/50 hover:text-accent transition-all duration-500 delay-500",
